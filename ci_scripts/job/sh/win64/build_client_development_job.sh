...
PROJECT_FILE="${PROJECT_ROOT}/DLCAndHotPatchTest.uproject"
ARCHIVE_DIR="${PROJECT_ROOT}/../DLCAndHotPatchTest_ci_build/${PLATFORM}/${GIT_BRANCH}/${GIT_REV_COUNT}/${BUILD_CONFIG}/"
mkdir -p ${ARCHIVE_DIR}
...
${UE4_ENGINE_ROOT}/Engine/Build/BatchFiles/RunUAT.bat" \
 ...
 -build -CrashReporter -utf8output -compile -createreleaseversion=${PLATFORM}
