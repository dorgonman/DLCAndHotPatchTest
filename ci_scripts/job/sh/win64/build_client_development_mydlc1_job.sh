...
ARCHIVE_DIR="${PROJECT_ROOT}/../${PROJECT_NAME}_ci_build/${PLATFORM}/${GIT_BRANCH}/${GIT_REV_COUNT}/${BUILD_CONFIG}/dlc"
mkdir -p ${ARCHIVE_DIR}
...
PAK_FILE=${ARCHIVE_DIR}/${PACKAGED_PLATFROM}/DLCAndHotPatchTest/Content/Paks/${PROJECT_NAME}-${PACKAGED_PLATFROM}.pak
[ -f ${PAK_FILE} ] && echo "Found" || echo "Not found"
mv ${PAK_FILE} \
   ${ARCHIVE_DIR}/${PACKAGED_PLATFROM}/DLCAndHotPatchTest/Content/Paks/${DLC_NAME}-${PACKAGED_PLATFROM}.pak
